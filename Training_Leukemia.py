...
temp = np.load('Preprocessed Dataset/With MI/Leukemia/MI_0.3_Leukemia.npy')
...
dbn = DBN(hidden_layers_structure=[50,10],
...
location = 'Model/Skenario 2/Leukemia/S2-50-10 MI 0.3 LR 0.04.npy'
